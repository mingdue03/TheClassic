...
$(document).ready( function(){
    ...
    var myWorkH1 =$('#myWork1').offset().top;
    var myWorkH2 =$('#myWork2').offset().top;
    var myWorkH3 =$('#myWork3').offset().top;
    var myWorkH4 =$('#myWork4').offset().top;
    var myWorkH5 =$('#myWork5').offset().top;
    ...
    $(window).scroll(function(i){
        ...
        if( scroll<=myWorkH1 && scroll>profileH+winH/2){
        ...
        for(var i=1; i<4 ; i++){
            if(scroll>myWorkH1+winH/3){
                $('.mockup_img1').animate({opacity:1},800)
            }}
        if(scroll>myWorkH1+winH/3){
            $('.mockup_img1').animate({opacity:1},800)
        }
        if(scroll>myWorkH2+winH/3){
            $('.mockup_img2').animate({opacity:1},800)
        }
        if(scroll>myWorkH4+winH/3){
            $('.mockup_img3').animate({opacity:1},800)
        }
