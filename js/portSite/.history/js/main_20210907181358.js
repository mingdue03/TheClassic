$(document).ready( function(){
    ...
    $(window).scroll(function(i){
        ...
        if(scroll>profileH+winH/3){
            $('.skill_wrap .photoskill').animate({width:'90%'},600);
            $('.skill_wrap .xdskill').animate({width:'90%'},600);
            $('.skill_wrap .htmlskill').animate({width:'90%'},600);
            $('.skill_wrap .javaskill').animate({width:'90%'},600);
        }
