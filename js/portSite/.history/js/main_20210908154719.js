$(document).ready( function(){
    ...
    $(window).scroll(function(i){
        ...
        if(scroll<=myWorkH && scroll>profileH+winH/2){
            ...
            $('.skill_wrap .photoskill').animate({width:'0%'},600);
            $('.skill_wrap .xdskill').animate({width:'0%'},600);
            $('.skill_wrap .htmlskill').animate({width:'0%'},600);
            $('.skill_wrap .javaskill').animate({width:'0%'},600);
        }
    });
